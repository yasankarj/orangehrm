 ...
 * @group ohrmWidget
 */
class ohrmWidgetJobTitleListTest  extends PHPUnit\Framework\TestCase
{
    /**
     * @var ohrmWidgetJobTitleList
     */
    private $ohrmWidgetJobTitleList = null;

    protected function setUp(): void
    {
        $this->ohrmWidgetJobTitleList = $this->getMockBuilder(ohrmWidgetJobTitleList::class)
